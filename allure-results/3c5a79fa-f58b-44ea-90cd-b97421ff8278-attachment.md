...
Error: strict mode violation: locator('text=created successfully').or(locator('text=Welcome')) resolved to 3 elements:
    ...
    2) <h1 class="title">Welcome Charlotte.lILicb</h1> aka getByRole('heading', { name: 'Welcome Charlotte.lILicb' })
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - generic [ref=e27]:
      - generic [ref=e28]:
        - paragraph [ref=e29]: Welcome Efrain Littel
        ...
        - list [ref=e31]:
          ...
          - listitem [ref=e46]:
            - link "Log Out" [ref=e47] [cursor=pointer]:
              - /url: logout.htm
      - generic [ref=e48]:
        - heading "Welcome Charlotte.lILicb" [level=1] [ref=e49]
