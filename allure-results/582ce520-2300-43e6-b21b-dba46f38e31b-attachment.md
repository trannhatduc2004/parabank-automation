...
- Name: api\tests\banking.api.spec.ts >> Banking API >> GET /accounts/:id/transactions — trả về lịch sử giao dịch @regression
- Location: src\api\tests\banking.api.spec.ts:61:7
