...
- Name: api\tests\banking.api.spec.ts >> Banking API >> GET /customers/:id/accounts — trả về danh sách tài khoản @smoke
- Location: src\api\tests\banking.api.spec.ts:21:7
